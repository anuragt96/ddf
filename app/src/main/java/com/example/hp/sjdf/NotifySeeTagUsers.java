...
public class NotifySeeTagUsers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notify_see_tag_users);

        Intent intent=getIntent();
        final String event1=intent.getStringExtra("event1");
        // tv.setText(event1);
        recyclerView = (RecyclerView) findViewById(R.id.notifyseeusers);
        ...
        loadNotesList();
        firestoreListener = mUser.collection("notification").document(event1).collection("Added_Users")
    ...
    private void loadNotesList() {
        ...
        com.google.firebase.firestore.Query query = mUser.collection("notification").document(event1).collection("Added_Users");
