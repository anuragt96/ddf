...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatToolbar=(Toolbar)findViewById(R.id.main_page);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent group=new Intent(getApplicationContext(),SeeTagUsers.class);
...
//                final String ts = tslong.toString();
                    ...
                    //uMap.put("Time", ts);
                    mUser.collection("Event").document(event).collection("message").add(uMap)
                    ...
                    mUser.collection("Event").document(event).collection("Added_Users").get()
    ...
    /*            Map<String, String> usMap = new HashMap<>();
        ...
        firestoreListener = mUser.collection("Event").document(event).collection("message")
    ...
    private void loadNotesList() {
        ...
        com.google.firebase.firestore.Query query = mUser.collection("Event").document(event).collection("message");
        ...
        adapter = new FirestoreRecyclerAdapter<Note, NoteRecyclerViewAdapter.ViewHolder>(response) {
            ...
            protected void onBindViewHolder(NoteRecyclerViewAdapter.ViewHolder holder, int position, Note model)
            {
                ...
                //Picasso.with(holder.iv.getContext()).load(note.getImage_msg()).fit().into(holder.iv);
