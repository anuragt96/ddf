...
import static com.example.hp.sjdf.R.id.circleImageView;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        if(requestCode == FILE_SELECT_CODE && resultCode == RESULT_OK)
        {
            ...
            if(uriString.startsWith("content://"))
            {
                Cursor cursor = null;
                try {
                    cursor = FileUpload.this.getContentResolver().query(fileuri, null , null , null, null);
...
//admin image send kr raha apne aap ko
                            ...
                            mUser.collection("Event").document(event).collection("message").add(uMap)
                                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                        ...
                                        public void onSuccess(DocumentReference documentReference) {
                                            Toast.makeText(FileUpload.this, "Succees", Toast.LENGTH_SHORT).show();
                                        }
                                    }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(FileUpload.this, "Failure", Toast.LENGTH_SHORT).show();
                                }
                            });
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            // ...
                            Toast.makeText(FileUpload.this, "Upload Cancelled", Toast.LENGTH_SHORT).show();
                        }
